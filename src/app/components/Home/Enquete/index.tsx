  ...
  return (
    ...
    >
      ...
      <div className="max-w-2xl mx-auto w-full py-32">
        <h2 className="text-5xl text-center mb-10 uppercase pb-3 font-bold text-[#004619]">
          Avalie nosso serviço
        </h2>

        <div className="bg-white border-4 border-slate-300 shadow-lg rounded-3xl px-8 py-9 md:mx-0 mx-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            ${
              nota === label
                ...
                : "bg-gray-100 text-gray-800 hover:bg-gray-300 border-2 border-slate-400"
            } 
            hover:scale-105`}
                >
                  {icon} {label}
            ...
            <button
              type="submit"
              className="w-full bg-slate-400 hover:bg-blue-900 border-2 border-slate-400 text-white text-xl py-3 rounded-xl transition-all duration-200 transform flex items-center justify-center hover:scale-105"
              disabled={loading}
            >
              {loading ? (
