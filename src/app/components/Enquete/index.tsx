...
const Poll = () => {
  ...
  return (
    <div className="flex justify-center items-center py-44 bg-gradient-to-b from-[#003470] via-[rgb(105,150,222)] to-[#003470]">
      <motion.div
        initial={{ opacity: 0, y: 100 }}
        animate={inView ? { opacity: 1, y: 0 } : { opacity: 0, y: 50 }}
        transition={{ duration: 1.2, ease: "easeInOut" }}
        ref={ref} // Aplica o ref aqui
        className="w-4/12 p-6 pb-10 bg-[#d3f0fb] text-cyan-900 border-4 border-emerald-900 shadow-lg rounded-3xl h-auto min-h-[360px] flex flex-col"
      >
        {submitted ? (
          <>
            <motion.div
